...
export const metadata: Metadata = {
  title: "موطني العقارية | شراء عقار في تركيا والحصول على الجنسية التركية",
  description:
    "اكتشف أفضل فرص الاستثمار العقاري في تركيا مع موطني العقارية. نوفر عقارات في اسطنبول مؤهلة للجنسية التركية مع استشارات قانونية وخيارات تقسيط مرنة.",
};
